...
//
// See: https://developer.genesys.cloud/notificationsalerts/notifications/available-topics#v2-detail-events-conversation--id--flow-end
...
func init() {
	notificationTopicRegistry.Add(ConversationFlowEndTopic{})
}
