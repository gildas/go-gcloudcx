...
//
// See: https://developer.genesys.cloud/notificationsalerts/notifications/available-topics#v2-detail-events-conversation--id--wrapup
...
func init() {
	notificationTopicRegistry.Add(ConversationWrapupTopic{})
}
