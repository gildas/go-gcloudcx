...
//
// See: https://developer.genesys.cloud/notificationsalerts/notifications/available-topics#v2-detail-events-conversation--id--acw
...
func init() {
	notificationTopicRegistry.Add(ConversationACWTopic{})
}
