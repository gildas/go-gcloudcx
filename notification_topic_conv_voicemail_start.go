...
//
// See: https://developer.genesys.cloud/notificationsalerts/notifications/available-topics#v2-detail-events-conversation--id--voicemail-start
...
func init() {
	notificationTopicRegistry.Add(ConversationVoicemailStartTopic{})
}
